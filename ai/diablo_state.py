...
class DiabloGame:
    def __init__(self, state_dir, proc, mshared_path, mmapped, state):
    ...
    def run(config):
        ...
        return DiabloGame(state_dir, proc, mshared_path, mmapped, state)

    @staticmethod
    def attach(mshared_path):
        mmapped, state = DiabloGame.attach_mshared_path(mshared_path)
        return DiabloGame(None, None, mshared_path, mmapped, state)
